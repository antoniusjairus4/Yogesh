import {
  require_jsx_runtime
} from "./chunk-CFHFPOGH.js";
import {
  __publicField,
  __toESM,
  require_react
} from "./chunk-W26Q3VDM.js";

// node_modules/@nkzw/liquid-glass/lib/index.js
...
var fragmentShaders = { liquidGlass: (uv) => {
  const ix = uv.x - 0.5;
  const iy = uv.y - 0.5;
...
var ShaderDisplacementGenerator = class {
  constructor(options) {
    ...
    __publicField(this, "canvasDPI", 1);
...
var GlassFilter = ({ aberrationIntensity, displacementScale, id, mode, shaderMapUrl }) => (0, import_jsx_runtime.jsx)("svg", {
  "aria-hidden": "true",
  height: "100%",
  style: { position: "absolute" },
  width: "100%",
  children: (0, import_jsx_runtime.jsxs)("defs", { children: [(0, import_jsx_runtime.jsxs)("radialGradient", {
    cx: "50%",
    cy: "50%",
    id: `${id}-edge-mask`,
    r: "50%",
    ...
    y: "-35%",
    children: [
      (0, import_jsx_runtime.jsx)("feImage", {
        height: "100%",
      ...
      (0, import_jsx_runtime.jsx)("feComponentTransfer", {
        in: "EDGE_INTENSITY",
        result: "EDGE_MASK",
        children: (0, import_jsx_runtime.jsx)("feFuncA", {
          tableValues: `0 ${aberrationIntensity * 0.05} 1`,
          type: "discrete"
        })
      }),
      (0, import_jsx_runtime.jsx)("feOffset", {
        dx: "0",
        dy: "0",
        in: "SourceGraphic",
        result: "CENTER_ORIGINAL"
      }),
      (0, import_jsx_runtime.jsx)("feDisplacementMap", {
        in: "SourceGraphic",
      ...
      (0, import_jsx_runtime.jsx)("feBlend", {
        in: "GREEN_CHANNEL",
        in2: "BLUE_CHANNEL",
        mode: "screen",
        result: "GB_COMBINED"
...
var GlassContainer = (0, import_react.forwardRef)(({ aberrationIntensity = 2, blurAmount = 12, borderRadius = 999, children, className = "", displacementScale = 25, glassSize, mode = "standard", onClick, onMouseDown, onMouseEnter, onMouseLeave, onMouseUp, overLight = false, padding = "24px 32px", saturation = 180, style }, ref) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime.jsx)(GlassFilter, {
      aberrationIntensity,
      displacementScale,
      id: filterId,
      mode,
...
function LiquidGlass({ aberrationIntensity = 2, blurAmount = 0.0625, borderRadius = 999, children, className = "", displacementScale = 70, elasticity = 0.15, globalMousePos: externalGlobalMousePos, mode = "standard", mouseContainer = null, mouseOffset: externalMouseOffset, onClick, overLight = false, padding = "24px 32px", saturation = 140, style }) {
  const glassRef = (0, import_react.useRef)(null);
  const [isHovered, setIsHovered] = (0, import_react.useState)(false);
  const [isActive, setIsActive] = (0, import_react.useState)(false);
  const [glassSize, setGlassSize] = (0, import_react.useState)({
    height: 0,
    width: 0
  });
  const [internalGlobalMousePos, setInternalGlobalMousePos] = (0, import_react.useState)({
    x: 0,
    y: 0
  });
  const [internalMouseOffset, setInternalMouseOffset] = (0, import_react.useState)({
    x: 0,
    y: 0
  });
  ...
  const isStickyOrFixed = (style == null ? void 0 : style.position) === "fixed" || (style == null ? void 0 : style.position) === "sticky";
  const transformStyle = {
    ...isStickyOrFixed ? style : null,
    transform: `translate(calc(-50% + ${calculateElasticTranslation().x}px), calc(-50% + ${calculateElasticTranslation().y}px)) ${isActive && Boolean(onClick) ? "scale(0.96)" : calculateDirectionalScale()}`,
    transition: "all ease-out 0.2s"
  };
  return (0, import_jsx_runtime.jsxs)("div", {
    style: isStickyOrFixed ? void 0 : {
      position: "relative",
      ...style
    },
    children: [
      ...
      (0, import_jsx_runtime.jsx)(GlassContainer, {
        aberrationIntensity,
        blurAmount,
        borderRadius,
        className,
      ...
      glassSize.height > 0 && glassSize.width > 0 && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("span", { style: {
        position: "absolute",
        ...transformStyle,
        ...
        width: glassSize.width
      } }), (0, import_jsx_runtime.jsx)("span", { style: {
        position: "absolute",
        ...transformStyle,
        background: `linear-gradient(
          ${135 + mouseOffset.x * 1.2}deg,
...
//# sourceMappingURL=@nkzw_liquid-glass.js.map
