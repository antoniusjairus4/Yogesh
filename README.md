...
## 🛠️ Agreed Tech Stack & Architecture

- **Framework**: React 19 + TypeScript
- **Build Tool**: Vite
- **Styling**: TailwindCSS + Custom Oceanic Deep-Sea Glassmorphism Theme
- **Animations**: Framer Motion (3D cards, smooth scroll reveals, ambient glow)
- **Icons**: Lucide React
- **Data Architecture**: Strongly typed data engine in `src/data/portfolioData.ts` for easy updates
- **Hosting & Deployment**: **GitHub Pages** (100% Free static bundle hosting via GitHub Actions)

---

## 🌊 Planned Pages & Core Features
...
3. **Taxonomic Species Discovery Gallery**
   - High-res macro photo & video catalog of discovered/cataloged species.
   - Interactive **Specimen Inspection Modal** (displays Kingdom -> Species classification, holotype details, discovery notes).

4. **Expedition Timeline & Map**
   - Interactive visual roadmap highlighting field survey locations (Andaman & Nicobar Islands, Lakshadweep, Gulf of Mannar, ZSI headquarters).

5. **Searchable Publications Database**
   - Real-time instant search & tag filters (by topic, year, journal).
...
- **Current Phase**: UI drafting & content structure alignment.
- **Next Session Plan**: Initialize Vite React TypeScript project, assemble global design tokens, and build out components.
